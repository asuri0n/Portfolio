...
<div id="photogrid">
    <?php 
    foreach (scandir("images/landscapes/thumbs/") as $key => $file)
    {
        if(explode('.',$file)[1] == "jpg") 
        {
        echo "<div class='thumbnail hidden' data-background='photo.image.large'>";
            echo "<img class='thumbimage' src='images/landscapes/fulls/".$file."' />"; // data-photoid="142425967"
            echo "<p></p>";
        echo "</div>";
        }
    } 
...
<div id="mainimage">
    <div id='photos' class='swipe'>
        <div class='swipe-wrap'>
            <?php 
            foreach (scandir("images/landscapes/fulls/") as $key => $file)
            {
                if(explode('.',$file)[1] == "jpg") 
                {
                    echo "<div class='img' data-image='images/landscapes/fulls/".$file."'>";
